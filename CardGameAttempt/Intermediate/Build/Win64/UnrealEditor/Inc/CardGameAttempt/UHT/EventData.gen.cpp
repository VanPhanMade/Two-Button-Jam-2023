...
template<> CARDGAMEATTEMPT_API UScriptStruct* StaticStruct<FEventData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Van_Documents_Projects_Unreal_CardGameAttempt_Source_CardGameAttempt_Public_Data_EventData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Van_Documents_Projects_Unreal_CardGameAttempt_Source_CardGameAttempt_Public_Data_EventData_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Van_Documents_Projects_Unreal_CardGameAttempt_Source_CardGameAttempt_Public_Data_EventData_h_3367538011(TEXT("/Script/CardGameAttempt"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_Van_Documents_Projects_Unreal_CardGameAttempt_Source_CardGameAttempt_Public_Data_EventData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Van_Documents_Projects_Unreal_CardGameAttempt_Source_CardGameAttempt_Public_Data_EventData_h_Statics::ScriptStructInfo),
		nullptr, 0);
